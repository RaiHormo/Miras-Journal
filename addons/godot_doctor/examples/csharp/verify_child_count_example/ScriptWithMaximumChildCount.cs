...
/// Used by GodotDoctor to show the <see cref="ValidationCondition.HasMaximumChildCount"/> helper.
/// </summary>
public partial class ScriptWithMaximumChildCount : Node, IValidatable
{
	/// <summary>Returns a <see cref="ValidationCondition"/> that fails if this node has more than 3 children.</summary>
	public Array GetValidationConditions()
	{
		...
		[
			...
			ValidationCondition.HasMaximumChildCount(this, 3, variableName: Name),
		];
