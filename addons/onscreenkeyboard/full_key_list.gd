## The Complete KeyList reconstructed from Godot 3 Docs. https://docs.godotengine.org/en/3.6/classes/class_@globalscope.html#enum-globalscope-keylist
enum FullKeyList {
	KEY_ESCAPE = 16777217,
	KEY_TAB = 16777218,
	...
	KEY_HOME = 16777229,
	KEY_END = 16777230,
	KEY_LEFT = 4194319,			# Same goes for
	KEY_UP = 16777232,			# Arrow buttons.
	KEY_RIGHT = 4194321,
	KEY_DOWN = 16777234,
	KEY_PAGEUP = 16777235,
